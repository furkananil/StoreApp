...
public class OrderController : Controller
{
    ...
    public OrderController(Cart cartService, IOrderRepository orderRepository, IConfiguration configuration)
    {
        cart = cartService;
    ...
    private Payment ProcessPayment()
    {
        ...
        options.SecretKey = _configuration.GetSection("Iyzico")["SECRET_KEY"];
        options.BaseUrl = _configuration.GetSection("Iyzico")["BASE_URL"];
